                ...
                items.map((item, index) =>
                {
                    ...
                    return (
                        <Button
                            ...
                            className={ `group relative flex h-12 w-20 cursor-pointer items-center justify-center rounded-full transition-colors duration-(--duration-fast) ${ isActive ? '' : 'hover:bg-btn-muted-hover' }` }>
                            ...
                            <Vertical className={ `relative items-center gap-1 transition-colors duration-(--duration-fast) ${ isActive ? 'text-txt-reverse' : 'text-txt-muted group-hover:text-txt-normal' }` }>
