 ...
 */
export default function Popover({ open, onClose, anchor = 'inset-x-0 top-full mt-1', role, className = '', children }: { open: boolean; onClose: () => void; anchor?: string; role?: string; className?: string; children: ReactNode })
{
    ...
    return (
        <>
            ...
            <div
                role={ role }
                className={ cn(surfacePanel, 'absolute rounded-surface p-1', anchor, layer.popover, className) }>
