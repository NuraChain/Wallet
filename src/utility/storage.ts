...
type StorageKey = 'App.Language' | 'App.Theme' | 'App.Network' | 'App.Networks' | 'App.Apps' | 'Wallet.Mnemonic' | 'Wallet.Password' | 'Wallet.Name' | 'Wallet.Accounts' | 'Wallet.Active' | 'Wallet.Tokens' | 'Wallet.TokensHidden' | 'Browser.View' | 'Browser.History' | 'Browser.Favorites' | 'Browser.Connections';
